...
<div class="block">
    ...
    <div class="element">
        <input type="checkbox" name="ContentClass_ezenhancedselection_donotallowremoval_value_{$class_attribute.id}" {section show=$class_content.do_not_allow_removal}checked{/section} /> <b>Do not allow removal of previously selected options</b>
    </div>
</div>
